...
export const ALL_COURSES = [
  ...
  },
  {
    ...
    fixedTypes: ["기초필수"],
    trackRelations: {},
    times: [{ day: 0, start: 16.5, duration: 1.5 }, { day: 4, start: 16.5, duration: 1.5 }],
    syllabus: {
        capacity: "60",
        classroom: "E7-224",
        contact: {
  ...
  },
  {
    ...
    syllabus: {
        ...
        classroom: "E7-L20",
        contact: {
            email: "hj.kwon@dgist.ac.kr",
            phone: "053-785-6326",
            office: "E3-609",
            office_hours: "Schedule in advance"
        },
        summary: "Students are introduced to both the theory and the practice of all basic manufacturing concepts. It covers all issues involved in manufacturing micro and nano electronic devices, including thin film process, lithography, and etching process as well as unit cell design rule.",
        methods: ["Lecture"],
        materials: "None",
        policies: "Credit for this course is NOT permitted if EE404 in the Electrical and Electronic track has already been taken.",
        grading: [
            { name: "Class Participation", percent: 10 },
            { name: "Homework", percent: 15 },
            { name: "Midterm Exam", percent: 30 },
        ...
        schedule: [
    	     "1주차:Overview of Micro/Nano fabrication process",
    	     "2주차:Essential electrical concepts & basic structure of transistor",
    	     "3주차:Lithography process",
    	     "4주차:Oxidation process",
    	     "5주차:Diffusion process",
    	     "6주차:Etching (I)",
    	     "7주차:Etching (II)",
    	     "8주차:Mid-term exam",
    	     "9주차:Thin film deposition (I)",
    	     "10주차:Thin film deposition (II)",
    	     "11주차:Ion implantation",
    	     "12주차:Process integration (I)",
    	     "13주차:Process integration (II)",
    	     "14주차:Other processes and application (I)",
    	     "15주차:Other processes and application (II)",
    	     "16주차:Final exam"
        ],
        textbook: ["Fundamentals of semiconductor fabrication	(Sze, S. M / 2004)", "Micromachined Transducers Sourcebook	(Kovacs, Gregory T.A / 2014)","Introduction to microelectronic fabrication	(Jaeger, Richard C / 2002)","Fundamentals of microfabrication : The science of miniaturization	(Madou, Marc J / 2011)"]
    }
  },
  {
    id: "EE406-01",
  ...
  { id: 'RP401-01', name: 'Thesis', prof: '문제일', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-02', name: 'Thesis', prof: '유성운', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-03', name: 'Thesis', prof: '김은경', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-04', name: 'Thesis', prof: '서병창', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-05', name: 'Thesis', prof: '김규형', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-06', name: 'Thesis', prof: '이석규', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-07', name: 'Thesis', prof: '이성배', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-08', name: 'Thesis', prof: '오용석', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-09', name: 'Thesis', prof: '이효상', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-10', name: 'Thesis', prof: '최한경', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-11', name: 'Thesis', prof: '유우경', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-12', name: 'Thesis', prof: '고재원', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-13', name: 'Thesis', prof: '엄지원', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-14', name: 'Thesis', prof: '백명인', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-15', name: 'Thesis', prof: '이광', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-16', name: 'Thesis', prof: '현정호', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-17', name: 'Thesis', prof: '조용철', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-18', name: 'Thesis', prof: '김민환', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP401-19', name: 'Thesis', prof: '박포정', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-01', name: 'Thesis', prof: '구재형', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-02', name: 'Thesis', prof: '이창훈', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-03', name: 'Thesis', prof: '남창훈', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-04', name: 'Thesis', prof: '우혜련', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-05', name: 'Thesis', prof: '곽준명', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-06', name: 'Thesis', prof: '이영삼', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-07', name: 'Thesis', prof: '이상임', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-08', name: 'Thesis', prof: '이병훈', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-09', name: 'Thesis', prof: '김민석', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-10', name: 'Thesis', prof: '이재민', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-11', name: 'Thesis', prof: '예경무', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-12', name: 'Thesis', prof: '김진해', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-13', name: 'Thesis', prof: '이종찬', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-14', name: 'Thesis', prof: '전영태', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-15', name: 'Thesis', prof: '김민식', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-16', name: 'Thesis', prof: '기영훈', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-17', name: 'Thesis', prof: '김유리', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-18', name: 'Thesis', prof: '정찬', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-19', name: 'Thesis', prof: '최일규', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-20', name: 'Thesis', prof: '김태완', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-21', name: 'Thesis', prof: '이송이', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP402-22', name: 'Thesis', prof: 'Felix Jonas', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-01', name: 'Thesis', prof: '오세훈', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-02', name: 'Thesis', prof: '김기섭', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-03', name: 'Thesis', prof: '김동욱', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-04', name: 'Thesis', prof: '김봉훈', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-05', name: 'Thesis', prof: '김소희', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-06', name: 'Thesis', prof: '김회준', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-07', name: 'Thesis', prof: '남강현', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-08', name: 'Thesis', prof: '문인규', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-09', name: 'Thesis', prof: '박경서', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-10', name: 'Thesis', prof: '박상현', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-11', name: 'Thesis', prof: '박석호', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-12', name: 'Thesis', prof: '박준혁', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-13', name: 'Thesis', prof: '송석호', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-14', name: 'Thesis', prof: '송철', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-15', name: 'Thesis', prof: '유재석', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-16', name: 'Thesis', prof: '윤동원', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-17', name: 'Thesis', prof: '이상훈', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-18', name: 'Thesis', prof: '이성민', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-19', name: 'Thesis', prof: '이아형', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-20', name: 'Thesis', prof: '이옥균', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-21', name: 'Thesis', prof: '이재홍', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-22', name: 'Thesis', prof: '임영섭', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-23', name: 'Thesis', prof: '장경인', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-24', name: 'Thesis', prof: '정소현', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-25', name: 'Thesis', prof: '한상윤', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP403-26', name: 'Thesis', prof: '황민호', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-01', name: 'Thesis', prof: '홍정일', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-02', name: 'Thesis', prof: '박기성', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-03', name: 'Thesis', prof: '김성균', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-04', name: 'Thesis', prof: '장낙천', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-05', name: 'Thesis', prof: '조창희', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-06', name: 'Thesis', prof: '서정필', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-07', name: 'Thesis', prof: '김철기', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-08', name: 'Thesis', prof: '정병혁', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-09', name: 'Thesis', prof: '강준구', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-10', name: 'Thesis', prof: '박진희', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-11', name: 'Thesis', prof: '이성원', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-12', name: 'Thesis', prof: '이신범', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-13', name: 'Thesis', prof: '홍선기', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-15', name: 'Thesis', prof: '성주영', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-16', name: 'Thesis', prof: '김아람', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-17', name: 'Thesis', prof: '서상원', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-18', name: 'Thesis', prof: '김종구', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-19', name: 'Thesis', prof: '김소연', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP404-20', name: 'Thesis', prof: '문혜원', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-01', name: 'Thesis', prof: '이호천', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-02', name: 'Thesis', prof: '이윤구', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-03', name: 'Thesis', prof: 'SANGARAJU SHANMUGAM', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-04', name: 'Thesis', prof: '이종수', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-05', name: 'Thesis', prof: '인수일', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-06', name: 'Thesis', prof: '최성호', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-07', name: 'Thesis', prof: '장연희', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-08', name: 'Thesis', prof: '이주혁', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-09', name: 'Thesis', prof: '양지웅', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-10', name: 'Thesis', prof: '김찬연', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-11', name: 'Thesis', prof: '호동해', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-12', name: 'Thesis', prof: '김운혁', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-13', name: 'Thesis', prof: '김진수', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-14', name: 'Thesis', prof: '이종민', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-15', name: 'Thesis', prof: '고서진', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP405-16', name: 'Thesis', prof: '김승현', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-01', name: 'Thesis', prof: '장재은', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-02', name: 'Thesis', prof: '박경준', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-03', name: 'Thesis', prof: '은용순', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-04', name: 'Thesis', prof: '이기준', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-05', name: 'Thesis', prof: '황재윤', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-06', name: 'Thesis', prof: '이정협', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-07', name: 'Thesis', prof: '권혁준', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-08', name: 'Thesis', prof: '김경대', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-09', name: 'Thesis', prof: '신동훈', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-10', name: 'Thesis', prof: '임성훈', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-11', name: 'Thesis', prof: '김선준', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-12', name: 'Thesis', prof: '창진호', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-13', name: 'Thesis', prof: '김예성', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-14', name: 'Thesis', prof: '윤종혁', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-15', name: 'Thesis', prof: '김백규', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-16', name: 'Thesis', prof: '서대원', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-17', name: 'Thesis', prof: '김가인', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-18', name: 'Thesis', prof: '송민영', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-19', name: 'Thesis', prof: '김영식', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-20', name: 'Thesis', prof: '이경태', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-21', name: 'Thesis', prof: '소진현', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-22', name: 'Thesis', prof: '이병권', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-23', name: 'Thesis', prof: '이병문', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-24', name: 'Thesis', prof: '최재호', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-25', name: 'Thesis', prof: '박대희', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-26', name: 'Thesis', prof: '최원석', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-27', name: 'Thesis', prof: '이용우', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-28', name: 'Thesis', prof: '김기섭', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-29', name: 'Thesis', prof: '최상현', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-30', name: 'Thesis', prof: '전민석', credit: 1.0, times: [{ day: 5, start: 15, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-31', name: 'Thesis', prof: '길현재', credit: 1.0, times: [{ day: 5, start: 9, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-32', name: 'Thesis', prof: '장준기', credit: 1.0, times: [{ day: 5, start: 9, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-33', name: 'Thesis', prof: '목지수', credit: 1.0, times: [{ day: 5, start: 9, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP406-34', name: 'Thesis', prof: '이민선', credit: 1.0, times: [{ day: 5, start: 9, duration: 5 }], categories: ['연구'], type: '전공선택', trackRelations: {} },

  // --- 3. URP (RP408) - type 필드 포함 ---
  { id: 'RP408-01', name: 'URP', prof: '문제일', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-02', name: 'URP', prof: '유성운', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-03', name: 'URP', prof: '김은경', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-04', name: 'URP', prof: '서병창', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-05', name: 'URP', prof: '김규형', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-06', name: 'URP', prof: '이석규', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-07', name: 'URP', prof: '이성배', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-08', name: 'URP', prof: '오용석', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-09', name: 'URP', prof: '이효상', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-10', name: 'URP', prof: '최한경', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-11', name: 'URP', prof: '유우경', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-12', name: 'URP', prof: '고재원', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-13', name: 'URP', prof: '엄지원', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-14', name: 'URP', prof: '백명인', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-15', name: 'URP', prof: '이광', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-16', name: 'URP', prof: '현정호', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-17', name: 'URP', prof: '최영철', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-18', name: 'URP', prof: '김민환', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-19', name: 'URP', prof: '박포정', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-20', name: 'URP', prof: '구재형', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-21', name: 'URP', prof: '이창훈', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-22', name: 'URP', prof: '남창훈', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-23', name: 'URP', prof: '우혜련', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-24', name: 'URP', prof: '곽준명', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-25', name: 'URP', prof: '이영삼', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-26', name: 'URP', prof: '이상임', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-27', name: 'URP', prof: '이병훈', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-28', name: 'URP', prof: '김민석', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-29', name: 'URP', prof: '이재민', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-30', name: 'URP', prof: '예경무', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-31', name: 'URP', prof: '김진해', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-32', name: 'URP', prof: '이종찬', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-33', name: 'URP', prof: '전영태', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-34', name: 'URP', prof: '김민식', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-35', name: 'URP', prof: '기영훈', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-36', name: 'URP', prof: '김유리', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-37', name: 'URP', prof: '정찬', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-38', name: 'URP', prof: '최일규', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-39', name: 'URP', prof: '김태완', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-40', name: 'URP', prof: '이송이', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-41', name: 'URP', prof: 'Felix Jonas', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-42', name: 'URP', prof: '오세훈', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-43', name: 'URP', prof: '김기섭', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-44', name: 'URP', prof: '김동욱', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-45', name: 'URP', prof: '김봉훈', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-46', name: 'URP', prof: '김소희', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-47', name: 'URP', prof: '김회준', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-48', name: 'URP', prof: '남강현', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-49', name: 'URP', prof: '문인규', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-50', name: 'URP', prof: '박경서', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-51', name: 'URP', prof: '박상현', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-52', name: 'URP', prof: '박석호', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-53', name: 'URP', prof: '박준혁', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-54', name: 'URP', prof: '송석호', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-55', name: 'URP', prof: '송철', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-56', name: 'URP', prof: '유재석', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-57', name: 'URP', prof: '윤동원', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-58', name: 'URP', prof: '이상훈', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-59', name: 'URP', prof: '이성민', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-60', name: 'URP', prof: '이아형', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-61', name: 'URP', prof: '이옥균', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-62', name: 'URP', prof: '이재홍', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-63', name: 'URP', prof: '임영섭', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-64', name: 'URP', prof: '장경인', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-65', name: 'URP', prof: '정소현', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-66', name: 'URP', prof: '한상윤', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-67', name: 'URP', prof: '황민호', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-69', name: 'URP', prof: '홍정일', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-70', name: 'URP', prof: '박기성', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-71', name: 'URP', prof: '김성균', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-72', name: 'URP', prof: '조낙천', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-73', name: 'URP', prof: '조창희', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-74', name: 'URP', prof: '서정필', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-75', name: 'URP', prof: '김철기', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-76', name: 'URP', prof: '정병혁', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-77', name: 'URP', prof: '강준구', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-78', name: 'URP', prof: '박진희', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-79', name: 'URP', prof: '이성원', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-80', name: 'URP', prof: '이신범', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-81', name: 'URP', prof: '홍선기', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-82', name: 'URP', prof: '이성기', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-83', name: 'URP', prof: '성주영', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-84', name: 'URP', prof: '김아람', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-85', name: 'URP', prof: '서상원', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-86', name: 'URP', prof: '김종구', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-87', name: 'URP', prof: '김소연', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-88', name: 'URP', prof: '문혜원', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-89', name: 'URP', prof: '이호천', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-90', name: 'URP', prof: '이용구', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-91', name: 'URP', prof: 'SANGARAJU SHANMUGAM', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-92', name: 'URP', prof: '이종수', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-93', name: 'URP', prof: '인수일', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-94', name: 'URP', prof: '최성호', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-95', name: 'URP', prof: '장윤희', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-96', name: 'URP', prof: '이주혁', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-97', name: 'URP', prof: '양지웅', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-98', name: 'URP', prof: '김찬연', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-99', name: 'URP', prof: '호동해', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-100', name: 'URP', prof: '김운혁', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-101', name: 'URP', prof: '김진수', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-102', name: 'URP', prof: '이종민', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-103', name: 'URP', prof: '고서진', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-104', name: 'URP', prof: '김승현', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-105', name: 'URP', prof: '장재은', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-106', name: 'URP', prof: '박경준', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-107', name: 'URP', prof: '은용순', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-108', name: 'URP', prof: '이기준', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-109', name: 'URP', prof: '황재윤', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-110', name: 'URP', prof: '이정협', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-111', name: 'URP', prof: '권혁준', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-112', name: 'URP', prof: '김경대', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-113', name: 'URP', prof: '신동훈', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-114', name: 'URP', prof: '임성훈', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-115', name: 'URP', prof: '김선준', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-116', name: 'URP', prof: '장진호', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-117', name: 'URP', prof: '김예성', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-118', name: 'URP', prof: '윤종혁', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-119', name: 'URP', prof: '김백규', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-120', name: 'URP', prof: '서대원', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-121', name: 'URP', prof: '김가인', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-122', name: 'URP', prof: '송민영', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-123', name: 'URP', prof: '김영식', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-124', name: 'URP', prof: '이경태', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-125', name: 'URP', prof: '소진현', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-126', name: 'URP', prof: '이병권', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-127', name: 'URP', prof: '이병문', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-128', name: 'URP', prof: '최재호', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-129', name: 'URP', prof: '박대희', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-130', name: 'URP', prof: '최원석', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-131', name: 'URP', prof: '이용우', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-132', name: 'URP', prof: '김기섭', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-133', name: 'URP', prof: '최상현', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-134', name: 'URP', prof: '전민석', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-135', name: 'URP', prof: '길현재', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-136', name: 'URP', prof: '장준기', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-137', name: 'URP', prof: '목지수', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },
  { id: 'RP408-138', name: 'URP', prof: '이민선', credit: 2.0, times: [{ day: 5, start: 9, duration: 2 }], categories: ['연구'], type: '전공선택', trackRelations: {} },

  { id: 'RP301-01', name: 'UGRP I - 니켈 촉매 반응을 통한 규소를 함유한 다치환 방향족 화합물의 합성', prof: '정병혁', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-02', name: 'UGRP I - 단일배위 저산화수 보론화합물의 합성 및 반응성 연구', prof: '문혜원', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-03', name: 'UGRP I - 세포 융합 기반 나이 조절을 통한 뇌질환 기전 억제 화합물 개발', prof: '김태완', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-04', name: 'UGRP I - 가시광선을 이용한 지속가능한 유기합성법 개발', prof: '서상원, 이성기', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-05', name: 'UGRP I - 생성형 AI 기반 I-Q 신호 복원 및 파운데이션 모델 연구', prof: '최재호', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-06', name: 'UGRP I - 초전도 큐비트 제작 및 특성 평가', prof: '유천열, 권상일', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-07', name: 'UGRP I - 뇌신경질환의 전자 시스템적 해석을 위한 뇌 디지털 트윈 개발', prof: '최지웅', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-08', name: 'UGRP I - 3D 프린팅으로 구현한 피부통합형 센서를 이용한 차세대 HCI 시스템 개발', prof: '이병문', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-09', name: 'UGRP I - 유튜브 협업 네트워크에서의 유튜버 관계 예측 및 군집 분석', prof: '장준기', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-10', name: 'UGRP I - 비불소계 고분자를 활용한 지속가능형 건식 음극 제조', prof: '김진수', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-11', name: 'UGRP I - 1.58-bit 초경량 VLA 와 소프트 로보틱스를 융합한 지능형 물체 전달 로봇팔 개발', prof: '송석호, 이상철', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-12', name: 'UGRP I - 인공지능 기반 자율주행 로봇의 협력·이타적 판단 및 주행을 위한 신개념 경로 계획 도출 연구', prof: '임용섭, 남강현', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-13', name: 'UGRP I - 새의 비행 적응에 관한 과학관 전시 모델 디자인', prof: '이상임, 박종래', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-14', name: 'UGRP I - 자외선 차단 기능성 생체모사 시나페이트-리그닌 복합 하이드로겔 기반 상처 치유 플랫폼 개발', prof: '홍선기', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-15', name: 'UGRP I - Chromatin remodeler의 기능 및 IDR 구조 분석을 통한 발암 억제 기능 연구', prof: '기영훈, Felix Jonas', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-16', name: 'UGRP I - 머신 러닝 기법을 활용한 엑스선 회절 이미지의 신호대잡음비 개선 및 구조동역학 정보의 복원', prof: '김종구', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-17', name: 'UGRP I - 물 정화를 위한 과불화화합물 흡착용 금속-유기 골격체 개발 연구', prof: '박진희', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-18', name: 'UGRP I - 세포 내에서의 RNA 분자의 단일 분자 수준 관찰', prof: '이종찬', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-19', name: 'UGRP I - AI 기반 세포막 수용체 활성 조절 및 질환 제어 메커니즘 연구', prof: '이창훈', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-20', name: 'UGRP I - 신경 퇴행성 질환에서 비만의 영향 및 매개 경로 규명', prof: '이성배', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-21', name: 'UGRP I -  대규모 미지 환경의 Exploration 효율 향상 및 다중 Task 완수를 위한 멀티 로봇의 랑데부 기반 분산 의사결정 전략 연구', prof: '김기섭', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-22', name: 'UGRP I - Sebacates 계열 PVC Gel 기반 트라이보전기 나노발전기의 온도 안정성 평가 및 웨어러블·IoT 응용', prof: '이주혁', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-23', name: 'UGRP I - EEG-초음파 멀티모달 입력을 활용한 실시간 초음파 지연 보완 예측 모델 연구', prof: '황재윤', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-24', name: 'UGRP I - XR 환경에서의 SDF 기반 연성 그림자(Soft Shadows)와 깊이 지각 정확도 연구', prof: '길현재', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-25', name: 'UGRP I - p-i-n 구조 페로브스카이트 태양 전지(PSCs)의 안정성 및 효율 개선을 위한 소재 개질 연구', prof: '최종민', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-26', name: 'UGRP I - 군집 드론의 강건성 확보를 위한 SLAM 기반 동적 임무 재분배 알고리즘 연구', prof: '김백규', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-27', name: 'UGRP I - 에어로겔 전환을 갖는 산불 화재 방지 자연기반 폴리페놀 하이드로겔', prof: '김성균', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-28', name: 'UGRP I - 비정형 환경 내 작업을 위한 Vision-Language-Action Model 기반 로봇 팔 제어 시스템 개발', prof: '박경준', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-29', name: 'UGRP I - 초고색순도 디스플레이 구현을 위한 양자점 기반 색변환층 개발', prof: '양지웅', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-30', name: 'UGRP I - 의미적 상태 추상화를 통한 생체 신호 기반 동적 장면 제어', prof: '목지수', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-31', name: 'UGRP I - 다양한 캠퍼스 환경에 대응하는 자율주행 구체 로봇 개발', prof: '김기섭, 박준혁', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-32', name: 'UGRP I - 사용자 상호작용형 멀티모달 로봇 디스플레이 제어 시스템', prof: '황민호', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-33', name: 'UGRP I - 장기간 모니터링을 위한 소형 ECG 장치의 전극 디자인 최적화 연구', prof: '이정협', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-34', name: 'UGRP I - 결함 허용 및 장애물 회피 기능을 갖춘 현수하물 탑재 드론의 강건 통합 비행 제어 시스템 연구', prof: '이성민', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-35', name: 'UGRP I - Active Notch Filter 기반 저잡음 아날로그 프런트엔드(AFE)를 활용한 고정밀 SSVEP-BCI 시스템 구현', prof: '송민영', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-36', name: 'UGRP I - 보상 신호 처리 과정 중 선조체 하위 영역별 도파민-세로토닌의 기능적 역할 탐구', prof: '이광', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-37', name: 'UGRP I - 2D 반도체 기반 양자소자 제작 및 극저온 분석을 위한 STM 고도화 연구', prof: '서정필, 정민경', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-38', name: 'UGRP I - 오디오-비디오 멀티모달 상호작용을 활용한 고정밀 비디오 템포럴 그라운딩 연구', prof: '박대희, 목지수', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-39', name: 'UGRP I - 인공지능을 활용한 상처 치료용 신규 미니바인더 설계 및 결합 구조 예측', prof: '이창훈', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-40', name: 'UGRP I - 인공 근육을 활용한 새 모사 로봇 개발', prof: '윤동원', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-41', name: 'UGRP I - 실시간 모니터링과 전기장 on demand 제어 기반 자율형 스마트 약물 방출 시스템', prof: '이재홍, 정소현', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-42', name: 'UGRP I - 가변적 로봇 통신 환경에 대응하는 적응형 이퀄라이제이션 연구', prof: '김가인', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-43', name: 'UGRP I - 로봇 파운데이션 모델 기반 데이터 효율적 작업 적응 기술 연구', prof: '임성훈', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-44', name: 'UGRP I - 비전 트랜스포머와 합성곱 신경망에서의 파국적 망각에 대한 비교 연구', prof: '김기섭', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-45', name: 'UGRP I - 자기 조립 로봇 군집', prof: '은용순', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-46', name: 'UGRP I - FPS 모바일 게임 환경에서 클로 그립 조작 효율성 극대화를 위한 UI 배치 최적화', prof: '김선준', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-47', name: 'UGRP I - Bilayer ionomer의 구성 비율 최적화를 통한 CO2 환원 반응의 염 침전 억제 연구', prof: '김찬연', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-48', name: 'UGRP I - 월드 모델 및 시맨틱 통신을 활용한 실시간 비동기 MARL: 버그하우스를 중심으로', prof: '박대희', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-49', name: 'UGRP I - Sodium 이온 전지의 열적 안정성 연구', prof: '이호춘', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-50', name: 'UGRP I - 소음 환경 취약계층의 수면 건강권 보장를 위한 회로 기반 ANC 수면 디바이스 개발', prof: '이경태', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
  { id: 'RP301-51', name: 'UGRP I - Fitbit 기반 실생활 수면 모니터링 및 fNIRS 분석을 통한 후각 솔루션의 고립 청년 자존감 회복 기전 규명', prof: '최한경', credit: 3.0, times: [{ day: 5, start: 18, duration: 3 }], categories: ['연구'], type: '전공필수', trackRelations: {} },
];