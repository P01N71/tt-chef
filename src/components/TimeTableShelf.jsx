...
const TimeTableShelf = () => {
    ...
    // ★ [수정됨] 진열대 모달 캘린더 내보내기 로직 (2학기 개강일 8월 24일 반영)
                    ...
                    <div className="bg-white w-full max-w-4xl max-h-[90vh] rounded-3xl shadow-2xl overflow-hidden flex flex-col">
                        ...
                        {!viewingItem.isGraduation && (
                            <div className="p-4 border-t border-slate-100 bg-white flex justify-center gap-3 flex-shrink-0">
                                ...
                                <button onClick={handleExportCalendar} className="flex items-center gap-2 px-6 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-500 shadow-lg hover:shadow-slate-500/30 transition-all">
